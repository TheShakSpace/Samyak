...
const footerLinks = {
  Product: ["Features", "Pricing", "API", "Voice Agent", "Dashboard"],
  Resources: ["Documentation", "Guides", "Blog", "Support", "Community"],
  Company: ["About", "Careers", "Contact", "Partners", "News"],
        ...
        >
          ...
          <div className="col-span-2 md:col-span-1">
            <a href="/" className="flex items-center gap-2 mb-4">
              <span className="font-bold text-white text-lg tracking-wider" style={{ fontFamily: "var(--font-mono)" }}>
                SAMYAK AI
              </span>
            </a>
            <p className="text-sm text-zinc-500 mb-4">Enterprise AI solutions with voice and autonomous capabilities.</p>
            {/* System Status */}
