  ...
  return (
    <section className="py-24 px-4">
      ...
      >
        ...
        >
          Task & Productivity for Remote Teams
        </h2>
        <p className="text-lg sm:text-xl text-zinc-400 mb-10 max-w-2xl mx-auto">
          Assign work, track progress, log hours, and get AI-powered productivity reports. Start free, no credit card required.
        </p>
        ...
        <p className="mt-8 text-sm text-zinc-500">Free tier available. Team plans start at $99/month.</p>
      </motion.div>
    </section>
  )
}
